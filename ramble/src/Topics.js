...
import { query, collection, doc, deleteDoc, onSnapshot, orderBy } from 'firebase/firestore';
...
function Topics() {
  ...
  useEffect(() => {
    const unsubscribe = onSnapshot(query(userPostCollectionRef, orderBy('topic')), snapshot => {
